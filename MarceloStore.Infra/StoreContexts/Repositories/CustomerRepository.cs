...
namespace MarceloStore.Infra.StoreContexts.Repositories
{
    public class CustomerRepository : ICustomerRepositorie
    {
        private readonly MarceloDataContext _context;

        public CustomerRepository(MarceloDataContext context)
        {
            _context = context;
        }
        ...
        public IEnumerable<ListCustomerQueryResult> Get()
        {
           ...
           .Query<ListCustomerQueryResult>(
               "SELECT [Id], CONCAT([FirstName],' ',[LastName]) AS [Name], [Document], [Email] FROM [Customer] ").ToList();
        ...
        public IEnumerable<ListCustomerOrdersQueryResult> GetOrders(Guid id)
        {
            return _context
                    .Connection
                    .Query<ListCustomerOrdersQueryResult>("", new { id = id }).ToList();
        }
